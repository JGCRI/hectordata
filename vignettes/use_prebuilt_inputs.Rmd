...
```{r}
ini_ssp119 <- system.file("input/rcmip_ssp119.ini", package = "hectordata")
ini_ssp460 <- system.file("input/rcmip_ssp460.ini", package = "hectordata")
ini_ssp585 <- system.file("input/rcmip_ssp585.ini", package = "hectordata")
```
